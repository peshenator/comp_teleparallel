...
\subsection{Transformation of the torsion equations}
...
After the above change of variables and potentials, the tetrad equations 
\eqref{eqn.1st.order.enermomen} and \eqref{eqn.1st.order.tetrad} are
\begin{subequations}
	\begin{align}
		\D{\mu}U_{\tetr{a}{\mu}} &= 0,\\[2mm]
		u^\mu(\D{\mu}\tetr{a}{\nu} - \D{\nu}\tetr{a}{\mu}) & =U_{\eT{a}{\nu}},
	\end{align}
\end{subequations}
...
{\color{Red} The energy-momentum is not symmetric. Some extra work is required....... }
