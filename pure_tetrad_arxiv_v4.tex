...
%	\end{gather*}
	...
	the presence of the total (gravity + matter) momentum and energy equations \eqref{eqn.3+1.m} and
	...
	scope of this paper. However, we can still analyze hyperbolicity of the
	...
	\begin{subequations}\label{eqn.Buchman.TEGR.KN}
		...
		\end{align}
	\end{subequations}
	We remark that due to our choice of the 3+1 split \eqref{eqn.h.eta.matrix},
