...
\reply{This is an important point that forced us re-read this section. We have found out that it was written misleadingly. In fact, we were not able to establish the exact equivalence of the two formulations but only of the principal parts of the differential operators (all differential terms for a first-order system). Which is sufficient for our hyperbolicity analysis. Unfortunatelly, we can not confirm nor disprove the complete equivalance at this stage because the algebraic parts of the systems do not match. This is also stated explicitly in the revised version. We carefully revisited Sec.10, and removed the misleading statements there, as well as in the abstract, introduction and conclusion. }
\\
