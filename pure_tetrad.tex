...
%		\gamma^{jk}\itetr{l}{\sA}\Bfin{\sA}{i},
		\Dfin{\indalg{0}}{k} =-\detTetr_3^{-1}\varkappa^{-1} \LCsymb^{kli} 
		\Bfinmix{}{li},
		\qquad
		\Dfin{ik}{} = \Dfin{ki}{},
		\\
...
\Ufin =-\rho_{\indalg{0}} \lapse$ in the expression of the stress tensor $ \stress{\sA}{i} $ into the 
...
\Dfin{\indalg{0}}{k} $ as $  \Dfin{\indalg{0}}{k} = -\detTetr_3 \varkappa^{-1} 
...
\Dfin{ij}{} $. The resulting equations read
