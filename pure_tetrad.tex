...
This system of 18 equations has \textit{only 10 eigenvectors} for the flat spacetime.
...
\begin{subequations}\label{eqn.A.Omega}
	\begin{align}
		...
		\itetr{j}{\sB} \hat{\Omega}^l) \mg{\sA\sB}
		 ...
		 = rhs, 
		\\[2mm]
		&\pd{t}\Omega_i -\shift{k}\pd{k}\Omega_i + {\color{red}\itetr{k}{\sA} \pd{k} 
		\Hfinn{\sA}{i}} 
		{\color{blue}
		- \itetr{k}{\sA} \pd{k}(\LCsymb_{ijl} \itetr{j}{\sA} \hat{A}^l)
		}= rhs.
	\end{align}
\end{subequations}
