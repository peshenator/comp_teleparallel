...
equations with torsion \cite{Torsion2019}. Moreover, it is almost (if not completely) identical to 
the dGREM formulation of the Einstein equations recently pushed forward in \cite{Olivares2022}. A 
