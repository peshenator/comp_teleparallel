...
As it is demonstrated in the supplementary materials [??] \IP{think if we want to provide 
Mathemtica files}, if one considers 18 equations written in a 
...
the same for the original TEGR equations \eqref{eqn.3+1.summary} because the differential operators 
of 
