...
There is also the cotangent space $ T_x^*M $ spanned by the coframe field $ \pdd{\mu} $. 
...
\ho{despite deep conceptual differences,}
it is almost identical to 
the dGREM formulation of the Einstein equations recently pushed forward in \cite{Olivares2022}.
\ho{However, it is important to mention that the Lagrangian approach adopted here
in principle permits to generalize the formulation to other $f(T)$ theories.}
