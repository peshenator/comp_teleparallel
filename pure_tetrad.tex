...
%	
	...
	numerical 
	general relativity. In this section, we relate $ \Dfin{\sA}{k} $ to the extrinsic curvature. In 
	what follows, we relate the extrinsic curvature of GR to the $ \Dfin{\sA}{k} $ field. We remark 
	that the two fields are conceptually different due to the different geometry interpretations in 
	GR and TEGR. Therefore, the obtained relation is possibly only due to the equivalence of TEGR 
	and GR. 
