...
class of equations equivalent to TEGR equations \eqref{eqn.3+1.summary} there is, at least one, 
possibility to rewrite TEGR vacuum equations as a symmetric hyperbolic system.
