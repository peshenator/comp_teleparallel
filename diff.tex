...
%DIF ADD pure_tetrad_arxiv_v4.tex   Thu Aug 28 00:27:41 2025
% Arsclassica Article
% LaTeX Template
% Version 1.1 (1/8/17)
%
...
\DIFaddend 
	...
	analysis. Moreover}\DIFaddend , we shall \DIFdelbegin \DIFdel{show that the vacuum }\DIFdelend \DIFaddbegin \DIFadd{assume that the lapse $\lapse$ and shift
	$\shift{i}$ are not dynamical but some prescribed functions of space and
	time.
}

	\DIFadd{We will show how the }\DIFaddend 3+1 \DIFdelbegin \DIFdel{TEGR equations are
	equivalent to the }\DIFdelend \DIFaddbegin \DIFadd{vacuum TEGR equations, when restricted to solutions
