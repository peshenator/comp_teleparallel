...
%DIF ADD pure_tetrad_arxiv_v4.tex   Thu Aug 21 12:36:06 2025
% Arsclassica Article
% LaTeX Template
% Version 1.1 (1/8/17)
%
...
\cite{Maluf2001a,Pati2022} }\hskip0pt%DIFAUXCMD
	...
	the Hamiltonian formalism in the use of conjugate variables and Legendre
	transforms, here }\DIFaddend we explore another line of deriving 3+1 formulation of TEGR
	which is rather aligned with the relativistic electrodynamics. \DIFaddbegin \DIFadd{In
	particular, the key difference from the Hamiltonian formulations
	\mbox{%DIFAUXCMD
\cite{Maluf2001a,Pati2022} }\hskip0pt%DIFAUXCMD
is in the promotion of the torsion to the
	dynamical variable with its own evolution equation. }\DIFaddend As the result, the
	obtained \DIFdelbegin \DIFdel{equations are complitelly
	}\DIFdelend \DIFaddbegin \DIFadd{3+1 equations are completely }\DIFaddend different from the mentioned papers \DIFaddbegin \DIFadd{and have a rather elegant structure similar to Maxwell's equations}\DIFaddend .
