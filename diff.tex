...
%DIF ADD pure_tetrad_arxiv_v4.tex   Tue Aug 26 13:49:15 2025
% Arsclassica Article
% LaTeX Template
% Version 1.1 (1/8/17)
%
...
\begin{document}
	...
	equations, we derive a first-order reduction of the second-order \DIFdelbegin \DIFdel{$ f(T) $-teleparallel
	gravity }\DIFdelend \DIFaddbegin \DIFadd{partial
	differential }\DIFaddend equations \DIFaddbegin \DIFadd{of the teleparallel equivalent of general relativity
	(TEGR) }\DIFaddend in the pure-tetrad formulation (no spin connection). We then \DIFdelbegin \DIFdel{restrict our attention to the teleparallel equivalent of general
	relativity (TEGR) and }\DIFdelend propose
...
%	\end{gather*}
	...
	\section{Hyperbolicity of the vacuum 3+1 TEGR equations}\DIFaddbegin \label{sec.hyperbolicity}
\DIFaddend 
...
%DIF < The low-order terms are given in the appendix\,\ref{}.
	...
	\eqref{eqn.3+1.B}, if coupled with \DIFdelbegin \DIFdel{the }\DIFdelend proper gauge conditions on $A_k$ and
	$\Omega_k$, are equivalent to \DIFdelbegin \DIFdel{a }\DIFdelend symmetric-hyperbolic system
	\eqref{eqn.KN.pde}--\eqref{eqn.aw.pde} \DIFdelbegin \DIFdel{. However, this is a very preliminary
	...
	was excluded from the consideration. }\DIFdelend \DIFaddbegin \DIFadd{on solutions satisfying the
